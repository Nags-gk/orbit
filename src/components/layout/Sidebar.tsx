    ...
    return (
        <>
            ...
            <aside className={cn(
                ...
                "md:top-4 md:left-4 md:h-[calc(100vh-2rem)] md:rounded-2xl md:border md:border-border",
                "glass bg-black/20",
                ...
                <div className="flex items-center justify-between p-6 border-b border-border/50">
                    ...
                    <button onClick={onClose} className="md:hidden p-1 hover:bg-foreground/10 rounded text-muted-foreground hover:text-foreground transition-colors">
                        <X className="w-6 h-6" />
                    </button>
                </div>
                    ...
                    {links.map((link) => (
                        <NavLink
                            ...
                            className={({ isActive }) => cn(
                                ...
                                isActive
                                    ? "text-primary bg-foreground/5 shadow-[0_0_20px_rgba(var(--primary),0.2)] border border-primary/20"
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div className="p-4 rounded-xl bg-gradient-to-br from-primary/20 to-accent/20 border border-border/50">
